        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>FULL STACK</h3>
              <h4>Building Complete Web Solutions</h4>
              <p>
                Developing end-to-end applications from responsive user interfaces 
                to scalable backend architecture. I love solving problems and building
                efficient systems.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Strong foundation in computer science principles. Experienced in data 
                structures, algorithms, object-oriented programming, and databases.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
